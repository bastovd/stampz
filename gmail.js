...
var Gmail = function(localJQuery) {
  ...
  */
  ...
  api.tools.add_helper_modal_window = function(title, content_html, onClickOk, onClickCancel, onClickClose) {
    ...
    container.attr('role', 'alertdialog');
    container.attr('aria-labelledby', 'gmailJsModalWindowTitle');
    container.attr('style', 'right:5%;top:95%;opacity:1;padding: 40px 0px 0px 0px;margin:0;background:#eee');
    ...
    contents.attr('class', 'Kj-JD-Jz');
	contents.attr('style', 'opacity:1;border-bottom-left-radius:5px;border-bottom-right-radius:5px;background:#eee');
    contents.html(content_html);
	contents.append(closeButton);
    ...
    var center = function() {
      container.css({
        top: ($(window).height() - container.outerHeight()) * 0.95,
        right: ($(window).width() - container.outerWidth()) * 0.05
      });
    };
